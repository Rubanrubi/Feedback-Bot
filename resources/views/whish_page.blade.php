    ...
    <body>
        ...
        <div class="container">
            <div class="balloon">
             ...
             <h1>Senthil Kumaran Baskaran</h1>
        </div>
        <br>
        <br>
        <br>
        <div style="text-align:center">
                 <a href="{{url('/')}}/landing" style="color: #fff;font-size: 40px;
    text-align: center!important;text-decoration:none;background: red;padding: 10px;border: red;border-radius: 10px;" class="btn btn-danger">Click Here To View Your Gift</a>
             </div>
        <script>
