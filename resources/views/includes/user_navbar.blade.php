    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand navbar-brand-center" href="index.html">
        ...
        <img class="navbar-brand-logo navbar-brand-logo-special" src="assets/images/logo-colored.png"
          title="Remark">
        <span class="navbar-brand-text hidden-xs-down">FDK BOT</span>
      </a>
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                    ...
                    <ul class="blocks-3">
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="https://getbootstrapadmin.com/remark/global/photos/view-1-150x100.jpg" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="https://getbootstrapadmin.com/remark/global/photos/view-2-150x100.jpg" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="https://getbootstrapadmin.com/remark/global/photos/view-3-150x100.jpg" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="https://getbootstrapadmin.com/remark/global/photos/view-4-150x100.jpg" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="https://getbootstrapadmin.com/remark/global/photos/view-5-150x100.jpg" alt="..." />
                        </a>
                      </li>
                      <li>
                        <a class="thumbnail m-0" href="javascript:void(0)">
                          <img class="w-full" src="https://getbootstrapadmin.com/remark/global/photos/view-6-150x100.jpg" alt="..." />
                        </a>
                      </li>
                    </ul>
                  </div>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                      ...
                      <div class="media">
                        <div class="pr-10">
                          <span class="avatar avatar-sm avatar-online">
                            <img src="https://getbootstrapadmin.com/remark/global/portraits/2.jpg" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="pr-10">
                          <span class="avatar avatar-sm avatar-off">
                            <img src="https://getbootstrapadmin.com/remark/global/portraits/3.jpg" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="pr-10">
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="https://getbootstrapadmin.com/remark/global/portraits/4.jpg" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="pr-10">
                          <span class="avatar avatar-sm avatar-away">
                            <img src="https://getbootstrapadmin.com/remark/global/portraits/5.jpg" alt="..." />
                            <i></i>
                          </span>
                        </div>
                        <div class="media-body">
          ...
          <li class="nav-item" id="toggleChat">
            <a class="nav-link waves-effect waves-light waves-round" onclick="open_sidebar()" href="javascript:void(0)" title="Chat" >
        ...
        <div>
          <ul class="site-menu" data-plugin="menu">
            ...
            <li class="dropdown site-menu-item has-sub">
              <a data-toggle="dropdown" href="{{url('/')}}/user_dashboard" data-dropdown-toggle="false">
 ...
 -->              </a>
            ...
            <li class="dropdown site-menu-item has-sub">
              <a data-toggle="dropdown" href="{{url('/')}}/branches" data-dropdown-toggle="false">
            ...
            <!-- <li class="dropdown site-menu-item has-section has-sub">
              <a data-toggle="dropdown" href="tables/shedule_management.html" data-dropdown-toggle="false">
                        <i class="site-menu-icon wb-bookmark" aria-hidden="true"></i>
                        <span class="site-menu-title">Feedback Form</span>
                        
                </a>
            </li> -->
            <!-- <li class="dropdown site-menu-item has-section has-sub">
              <a data-toggle="dropdown" href="tables/message.html" data-dropdown-toggle="false">
                        <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
                        <span class="site-menu-title">Messaging/Inbox</span>
